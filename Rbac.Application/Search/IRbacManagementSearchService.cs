...
public sealed class RuleSearchResult { public string DxEId { get; init; } = string.Empty; public string RuleCode { get; init; } = string.Empty; public string PermissionCode { get; init; } = string.Empty; public string Title { get; init; } = string.Empty; public string Type { get; init; } = string.Empty; public string Status { get; init; } = string.Empty; public string Icon { get; init; } = string.Empty; public string Remark { get; init; } = string.Empty; }
