...
public sealed class UserSearchResult { public string Userid { get; init; } = string.Empty; public string Username { get; init; } = string.Empty; public string Status { get; init; } = string.Empty; public IList<string> ProjectCodes { get; init; } = new List<string>(); public IList<string> GroupCodes { get; init; } = new List<string>(); public IList<string> GroupNames { get; init; } = new List<string>(); }
